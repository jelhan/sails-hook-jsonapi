...
test('Fetching single record: simple', function (t) {
  t.plan(9);
...
test('Fetching single record: to-one relationship', function (t) {
  t.plan(11);
...
test('Fetching single record: many-to relationship', function (t) {
  t.plan(12);
